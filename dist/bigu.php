...
<body>
    ...
    <main class="page_main">
        ...
        <section class="block_1 container scroll-trigger">
            <div class="article_content">
                <h3 class="article_subtitle scroll-target">辟穀營課程</h3>
                <p class="article_body scroll-target">
                    漸進式的七日體驗營，學習一種全新的健康生活方式，不被三餐綁架的自由飲食方法，採取第一.二天「輕辟」、第三.四天「微辟」、第五.六天「水辟」
                    <br />讓妳從此以後身體啟動自癒本能、自然瘦身、不再深陷反覆肥胖之苦
                    <br />辟穀營含二大課程
                    <br />一是辟穀理論，讓你全盤學習少食健身的觀念
                    <br />二是正念課程，一堂讓你回到欲界生活擁有強大正念，不再捲入暴飲暴食的漩渦
                </p>
            </div>
            <div class="event_01_img showcase_photo scroll-target" >
        ...
        <section class="block_2 container scroll-trigger">
            <div class="article_content">
                ...
                <p class="article_body scroll-target">生命真正的改變與蛻變</p>
            </div>
            <div class="videos scroll-target">
                <div class="video">
                    <iframe src="https://www.youtube.com/embed/HfPYnY0Va88?si=cTHIEn8d1X6FSriP" frameborder="0"
